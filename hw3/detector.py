...
class Detector:
    def __init__(self, model_path='yolo11x.pt'):
        ...
        self.model.overrides['conf'] = 0.2  # NMS confidence threshold: higher the value it is, less false postive
        self.model.overrides['iou'] = 0.45  # NMS IoU threshold: avoid replicated bounding boxes
